...
public partial class BbshopContext : DbContext
{
    public BbshopContext()
    {
    }

    public BbshopContext(DbContextOptions<BbshopContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=BBShop;Integrated Security=True;Trust Server Certificate=True");
